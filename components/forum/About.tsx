...
export function About() {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="bg-background px-6 py-28 lg:py-36"
    >
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <h2 className="mb-16 max-w-3xl text-balance text-3xl font-semibold tracking-tight text-foreground sm:text-4xl lg:text-5xl">
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
            <article className="space-y-5">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground">
                FORUM 2025 создаёт среду, где бизнес и технологии встречаются
        ...
        <motion.div
          ...
          className="grid gap-12 border-t border-border pt-16 sm:grid-cols-3 lg:gap-16 lg:pt-20"
        >
          {stats.map((stat) => (
            <div key={stat.label} className="text-center sm:text-left">
              <div className="mb-3 text-5xl font-semibold tracking-tight text-foreground lg:text-6xl">
